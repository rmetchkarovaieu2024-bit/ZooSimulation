...
class ZooFacade: # Single entry point to run the entire simulation with a simple interface
    ...
    def _build(self):
        ...
        zoo, exs, animals, _ = (
            ...
            .with_animals([
                ("Elephant", "Dumbo", 25, "Elephant Grounds"),
                ("Elephant", "Nandita", 6, "Elephant Grounds"),
                ("Parrot", "Polly", 2, "Tropical Bird House"),
                ("Eagle", "Aquila", 19, "Tropical Bird House"),
                ("Penguin", "Pebble", 7, "Tropical Bird House"),
                ("Flamingo", "Rosa", 4, "Tropical Bird House"),
                ("Owl", "Hoot", 8, "Tropical Bird House"),
                ("Snake", "Viper", 2, "Reptile House"),
                ("Crocodile", "Crunch", 23, "Reptile House"),
                ("Turtle", "Shell", 46, "Reptile House"),
                ("Lizard", "Gecko", 4, "Reptile House"),
                ("Chameleon", "Kali", 2, "Reptile House"),
                ("Frog", "Ribbit", 1, "Amphibian Centre"),
                ("Toad", "Bumpy", 4, "Amphibian Centre"),
                ("Salamander", "Sal", 3, "Amphibian Centre"),
                ("Newt", "Newton", 1, "Amphibian Centre"),
                ("Axolotl", "Axel", 2, "Amphibian Centre"),
                ("Goldfish", "Goldie", 2, "Aquarium"),
            ])
